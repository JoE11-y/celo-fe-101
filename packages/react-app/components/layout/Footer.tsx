...
46 -11 37 11 -5 36 -29 55 -53z"
  ...
  {
    name: "GitHub",
    href: "https://github.com/JoE11-y/celo-fe-101",
    icon: (props: Props) => (
...
export default function Footer() {
  return (
    <footer className="bg-gray-500 mt-auto border-black border-t">
      <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          ...
          Submission for Dacade by JoeEdoh &copy;   {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
